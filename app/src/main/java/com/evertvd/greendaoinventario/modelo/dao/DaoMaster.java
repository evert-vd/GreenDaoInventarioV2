...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        InventarioDao.createTable(db, ifNotExists);
        ZonaDao.createTable(db, ifNotExists);
        Zona_has_InventarioDao.createTable(db, ifNotExists);
        ProductoDao.createTable(db, ifNotExists);
        ConteoDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        InventarioDao.dropTable(db, ifExists);
        ZonaDao.dropTable(db, ifExists);
        Zona_has_InventarioDao.dropTable(db, ifExists);
        ProductoDao.dropTable(db, ifExists);
        ConteoDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(InventarioDao.class);
        registerDaoClass(ZonaDao.class);
        registerDaoClass(Zona_has_InventarioDao.class);
        registerDaoClass(ProductoDao.class);
        registerDaoClass(ConteoDao.class);
